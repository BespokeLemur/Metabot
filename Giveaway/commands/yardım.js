...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .setTitle('Meta Çekiliş Botu Yardım Menüsü')
        ...
        .setFooter(`Developed by BespokeLemur 💖`)
        .setThumbnail(client.user.avatarURL());
        const buton = new MessageButton().setLabel('Meta Giveaway').setStyle('LINK').setURL('http://bespokelemur.tk');
